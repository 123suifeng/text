...
Series_Force = Thruster_1(2:Num_Delta)';
...
F1 = Thruster_1(1);
    ...
    for i= 2:1:(n+1)
        ...
        Temp_Transfer_Couple_Num = Transfer_Couple_Num;
         ...
         save('E:\\12-AIAA-Codes\\Result1\\Realn2.mat','Realn2');  
         save('E:\\12-AIAA-Codes\\Result1\\Realn3.mat','Realn3');  
         
         save('E:\\12-AIAA-Codes\\Result1\\Remain_Couples.mat','Remain_Couples');  
         save('E:\\12-AIAA-Codes\\Result1\\Remain_Thrusters.mat','Remain_Thrusters');  
         
         save('E:\\12-AIAA-Codes\\Result1\\FinalN3.mat','FinalN3');  
         
         save('E:\\12-AIAA-Codes\\Result1\\Statu','Statu');
         save('E:\\12-AIAA-Codes\\Result1\\Statu2','Statu2');
         
         save('E:\\12-AIAA-Codes\\Result1\\DynamicLineSegment','Data');
